...
inputD1 = csvread("/home/pinkpanther/Documents/Studies/Master Thesis/Data/octave/mimic/amino transferase/originalData/crossoriginal1.csv");
...
inputD2 = csvread("/home/pinkpanther/Documents/Studies/Master Thesis/Data/octave/mimic/amino transferase/originalData/crossoriginal2.csv");
...
inputD3 = csvread("/home/pinkpanther/Documents/Studies/Master Thesis/Data/octave/mimic/amino transferase/originalData/crossoriginal3.csv");
...
%----- 8a. load testset
inputtest = csvread("/home/pinkpanther/Documents/Studies/Master Thesis/Data/octave/mimic/amino transferase/originalData/crossoriginal4.csv");
...
disp("Iteration 2");
%----- 2a. load cross validation set 1
inputD1 = csvread("/home/pinkpanther/Documents/Studies/Master Thesis/Data/octave/mimic/amino transferase/originalData/crossoriginal2.csv");
%disp(size(inputD1)); %-- 2588 17
...
%----- 2b. load cross validation set 2
inputD2 = csvread("/home/pinkpanther/Documents/Studies/Master Thesis/Data/octave/mimic/amino transferase/originalData/crossoriginal3.csv");
%disp(size(inputD2)); %-- 2588 17
...
%----- 2c. load cross validation set 3
inputD3 = csvread("/home/pinkpanther/Documents/Studies/Master Thesis/Data/octave/mimic/amino transferase/originalData/crossoriginal4.csv");
%disp(size(inputD3)); %-- 2588 17
...
%----- 6a. load testset
inputtest = csvread("/home/pinkpanther/Documents/Studies/Master Thesis/Data/octave/mimic/amino transferase/originalData/crossoriginal1.csv");
%disp(size(inputtest)); %-- 2588 17
...
disp("Iteration 3");
%----- 2a. load cross validation set 1
inputD1 = csvread("/home/pinkpanther/Documents/Studies/Master Thesis/Data/octave/mimic/amino transferase/originalData/crossoriginal3.csv");
%disp(size(inputD1)); %-- 2588 17
...
%----- 2b. load cross validation set 2
inputD2 = csvread("/home/pinkpanther/Documents/Studies/Master Thesis/Data/octave/mimic/amino transferase/originalData/crossoriginal4.csv");
%disp(size(inputD2)); %-- 2588 17
...
%----- 2c. load cross validation set 3
inputD3 = csvread("/home/pinkpanther/Documents/Studies/Master Thesis/Data/octave/mimic/amino transferase/originalData/crossoriginal1.csv");
%disp(size(inputD3)); %-- 2588 17
...
%----- 6. calculating accuracy of the test set
%----- 6a. load testset
inputtest = csvread("/home/pinkpanther/Documents/Studies/Master Thesis/Data/octave/mimic/amino transferase/originalData/crossoriginal2.csv");
%disp(size(inputtest)); %-- 2588 17
...
disp("Iteration 4");
%----- 2a. load cross validation set 1
inputD1 = csvread("/home/pinkpanther/Documents/Studies/Master Thesis/Data/octave/mimic/amino transferase/originalData/crossoriginal4.csv");
%disp(size(inputD1)); %-- 2588 17
...
%----- 2b. load cross validation set 2
inputD2 = csvread("/home/pinkpanther/Documents/Studies/Master Thesis/Data/octave/mimic/amino transferase/originalData/crossoriginal1.csv");
%disp(size(inputD2)); %-- 2588 17
...
%----- 2c. load cross validation set 3
inputD3 = csvread("/home/pinkpanther/Documents/Studies/Master Thesis/Data/octave/mimic/amino transferase/originalData/crossoriginal2.csv");
%disp(size(inputD3)); %-- 2588 17
...
%----- 6. calculating accuracy of the test set
%----- 6a. load testset
inputtest = csvread("/home/pinkpanther/Documents/Studies/Master Thesis/Data/octave/mimic/amino transferase/originalData/crossoriginal3.csv");
%disp(size(inputtest)); %-- 2588 17
