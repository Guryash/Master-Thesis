...
%----- 8a. load testset
inputtest = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/linearData/crosslinear3.csv");
...
disp("Iteration 2");
%----- 2a. load cross validation set 1
inputD1 = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/linearData/crosslinear2.csv");
%disp(size(inputD1)); %-- 271 17
...
%----- 2b. load cross validation set 2
inputD2 = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/linearData/crosslinear3.csv");
%disp(size(inputD2)); %-- 271 17
...
%----- 8. calculating accuracy of the test set
%----- 8a. load testset
inputtest = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/linearData/crosslinear1.csv");
%disp(size(inputtest)); %-- 271 17
...
disp("Iteration 3");
%----- 2a. load cross validation set 1
inputD1 = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/linearData/crosslinear3.csv");
%disp(size(inputD1)); %-- 271 17
...
%----- 2b. load cross validation set 2
inputD2 = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/linearData/crosslinear1.csv");
%disp(size(inputD2)); %-- 271 17
...
%----- 8. calculating accuracy of the test set
%----- 8a. load testset
inputtest = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/linearData/crosslinear2.csv");
%disp(size(inputtest)); %-- 271 17
