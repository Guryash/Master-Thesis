...
inputD1 = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/linearData/crossbetterlinear1.csv");
...
inputD2 = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/linearData/crossbetterlinear2.csv");
...
%----- 8a. load testset
inputtest = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/linearData/crossbetterlinear3.csv");
...
disp("Iteration 2");
%----- 2a. load cross validation set 1
inputD1 = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/linearData/crossbetterlinear2.csv");
%disp(size(inputD1)); %-- 154 17
...
%----- 2b. load cross validation set 2
inputD2 = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/linearData/crossbetterlinear3.csv");
%disp(size(inputD2)); %-- 154 17
...
%----- 8. calculating accuracy of the test set
%----- 8a. load testset
inputtest = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/linearData/crossbetterlinear1.csv");
%disp(size(inputtest)); %-- 154 17
...
disp("Iteration 3");
%----- 2a. load cross validation set 1
inputD1 = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/linearData/crossbetterlinear3.csv");
%disp(size(inputD1)); %-- 154 17
...
%----- 2b. load cross validation set 2
inputD2 = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/linearData/crossbetterlinear1.csv");
%disp(size(inputD2)); %-- 154 17
...
%----- 8. calculating accuracy of the test set
%----- 8a. load testset
inputtest = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/linearData/crossbetterlinear2.csv");
%disp(size(inputtest)); %-- 154 17
