...
[cost,grad] = Script3_sparseAutoencoder(theta, inputSize, hiddenLayer1Size, hiddenLayer2Size, outputSize, inputD, yD, lambda);


%----- 6. implement gradient checking 
numgrad = Script4_gradientChecking(@(x) Script3_sparseAutoencoder(x, inputSize, hiddenLayer1Size, hiddenLayer2Size, outputSize, inputD, yD, lambda), theta);
...
[opttheta, cost] = minFunc( @(p) Script3_sparseAutoencoder(p, inputSize, hiddenLayer1Size, hiddenLayer2Size, outputSize, inputD, yD, lambda), theta, options);

%size(opttheta) %--171 1


%----- 8. calculating accuracy of the training set
predict = Script5_predict(inputD, opttheta, inputSize, hiddenLayer1Size, hiddenLayer2Size, outputSize);
...
predicttest = Script5_predict(inputtest, opttheta, inputSize, hiddenLayer1Size, hiddenLayer2Size, outputSize);
