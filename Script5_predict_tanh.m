function p = Script5_predict_tanh(X, theta, inputSize, hiddenLayer1Size, outputSize) %p = PREDICT(X, theta, inputSize, hiddenLayer1Size, outputSize) computes the predictions for X using a threshold at 0.0
