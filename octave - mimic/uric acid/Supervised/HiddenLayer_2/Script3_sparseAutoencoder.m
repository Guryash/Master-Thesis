function [cost,grad] = Script3_sparseAutoencoder(theta, inputSize, hiddenLayer1Size, hiddenLayer2Size, outputSize, data, y, lambda)
...
delta4 = -(y' - activation4).* activation4 .* (1-activation4);
%size(delta4) %-- 1 569

%----- 5b. calculating error term for layer 3
delta3 = (W3'*delta4) .* activation3 .* (1-activation3); 
%size(delta3) %-- 10 569
