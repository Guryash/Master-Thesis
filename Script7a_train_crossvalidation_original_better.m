...
inputD1 = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/originalData/crossbetteroriginal1.csv");
%disp(size(inputD1)); %-- 154 17

yD1 = inputD1(:,1);
%size(yD1) %-- 154 1

inputD1 = inputD1(:,3:end); 
%disp(size(inputD1)); %-- 154 15

%----- 2b. load cross validation set 2
inputD2 = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/originalData/crossbetteroriginal2.csv");
%disp(size(inputD2)); %-- 154 17
...
%----- 8a. load testset
inputtest = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/originalData/crossbetteroriginal3.csv");
%disp(size(inputtest)); %-- 154 17

ytest = inputtest(:,1);
%size(ytest) %-- 154 1

inputtest = inputtest(:,3:end); 
%disp(size(inputtest)); %-- 154 15
...
disp("Iteration 2");
%----- 2a. load cross validation set 1
inputD1 = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/originalData/crossbetteroriginal2.csv");
%disp(size(inputD1)); %-- 154 17
...
%----- 2b. load cross validation set 2
inputD2 = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/originalData/crossbetteroriginal3.csv");
%disp(size(inputD2)); %-- 154 17
...
%----- 8. calculating accuracy of the test set
%----- 8a. load testset
inputtest = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/originalData/crossbetteroriginal1.csv");
%disp(size(inputtest)); %-- 154 17
...
%printf('true positives of training set for Iteration 2: %f\n', tptrain);
%printf('true negatives of training set for Iteration 2: %f\n', tntrain);
%printf('false positives of training set for Iteration 2: %f\n', fptrain);
%printf('false negatives of training set for Iteration 2: %f\n', fntrain);
...
%printf('true positives of testing set for Iteration 2: %f\n', tptest);
%printf('true negatives of testing set for Iteration 2: %f\n', tntest);
%printf('false positives of testing set for Iteration 2: %f\n', fptest);
%printf('false negatives of testing set for Iteration 2: %f\n', fntest);

printf('total true positives Iteration 2: %f\n', tptrain + tptest);
printf('total true negatives Iteration 2: %f\n', tntrain + tntest);
printf('total false positives Iteration 2: %f\n', fptrain + fptest);
printf('total false negatives Iteration 2: %f\n', fntrain + fntest);
...
disp("Iteration 3");
%----- 2a. load cross validation set 1
inputD1 = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/originalData/crossbetteroriginal3.csv");
%disp(size(inputD1)); %-- 154 17
...
%----- 2b. load cross validation set 2
inputD2 = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/originalData/crossbetteroriginal1.csv");
%disp(size(inputD2)); %-- 154 17
...
%----- 8. calculating accuracy of the test set
%----- 8a. load testset
inputtest = csvread("/home/pinkpanther/Documents/Studies/Semester 6 & 7 - Master Thesis/Data/octave/mimic/uric acid/originalData/crossbetteroriginal2.csv");
%disp(size(inputtest)); %-- 154 17
